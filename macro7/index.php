...
<body>
	<?php
		if($_COOKIE['result']){
			...
			print "<div id='resultBox'><img id='image' src='assignment07_images/".$_COOKIE['result'].".jpeg'></div>";
			print "<div id='resultBox2'><h3>".$_COOKIE['result']. "!</h3></div>";
			// print "<div id='submit'><button>Take Again?</button></div>";
		?>
			<!-- <form action="processresults.php" method="GET" id="form1">
				<div id='submit'><button type="submit" form="form1" value="retake">Take Again?</button></div>
			</form> -->
			<div id='resultBox2'>
